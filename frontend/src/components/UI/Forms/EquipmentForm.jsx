...
const EquipmentForm = ({ onClose }) => {
  ...
  const adminFields = [
    ...
    "Серисная_Организация", "Диагональ", "Количество_Мегапикселей", "Количество_портов", "Отпечатано_страниц"
  ];
  ...
  const standardFields = [
    ...
    "Заправлен", "Дата_последней_заправки", "Серисная_Организация", "Диагональ", "Количество_Мегапикселей", 
    "Количество_портов", "Отпечатано_страниц"
  ];
